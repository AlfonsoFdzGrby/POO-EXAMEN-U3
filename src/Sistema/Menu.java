...
public class Menu {
    ...
    private static void menuInversionista(){
        ...
        while(usuarioEnSesion.getUsuarioActual()!=null){
            ...
            opc = Tools.nextInt();
            switch (opc) {
                case 1 -> inversionista.invertir();
                case 2 -> inversionista.retirar();
    ...
    */
    ...
    private static void menuGerente(){
        int opc = 0;
        Empleado empleado = (Empleado)usuarioEnSesion.getUsuarioActual();
        while(usuarioEnSesion.getUsuarioActual()!=null){
